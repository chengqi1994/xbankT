...
import com.hiaward.dataprocess.message.util.CryptoUtils;
...
//		{
//			String strBinary = DataConversion.getZeroPrefixStr(Integer.toBinaryString(bArr[i]),8);
//			bf.append(strBinary);
//			
//		}
//		return bf.toString();
  ...
  public static void main(String args[]) throws Exception
  {
	  ...
	  String result = DataConversion.atob(DataConversion.hex2Byte(strValue));
	 ...
	 // System.out.println(result);
	  ...
	  String strValue2 = DataConversion.atob(strValue.getBytes());
	  
		byte[] bTemp = DataConversion.atoc(strValue2);
